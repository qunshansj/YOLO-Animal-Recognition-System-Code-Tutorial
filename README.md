...
# 1.图片识别
![2.png](4f59bffb06881f0f2e365d09302e9dad.png)

![3.png](27024d5ace28be17432f35846370cc97.png)

![4.png](2ea093e33017899393441be7b66fe6f2.png)
...
# 3.视频演示
[[YOLOv7]基于YOLOv7的水果识别系统(源码＆部署教程)_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1FD4y1z7NP/?vd_source=bc9aec86d164b67a7004b996143742dc)



# 4.准备YOLOv7格式数据集
如果不懂yolo格式数据集是什么样子的，[建议先学习一下该博客](https://afdian.net/item?plan_id=0ecd69f85fe611edaf8c52540025c377)。大部分CVer都会推荐用labelImg进行数据的标注，我也不例外，推荐大家用labelImg进行数据标注。不过这里我不再详细介绍如何使用labelImg，网上有很多的教程。同时，标注数据需要用到图形交互界面，远程服务器就不太方便了，因此建议在本地电脑上标注好后再上传到服务器上。

这里假设我们已经得到标注好的yolo格式数据集，那么这个数据集将会按照如下的格式进行存放。
![n.png](3ca25573fa7fd5ffaad3bc5110d0c594.png)
...
# 5.修改配置文件
参考[该博客教程](https://mbd.pub/o/bread/Y5WUmZdv)，总共有两个文件需要配置，一个是/yolov7/cfg/training/yolov7.yaml，这个文件是有关模型的配置文件；一个是/yolov7/data/coco.yaml，这个是数据集的配置文件。
...
![b.png](140a7857bd46faf57c292f135d744b91.png)
...
![k.png](d76f001ee3e605d7fdbd3fb9d2b0c9d4.png)
...
# 8.系统整合
下图[完整源码&环境部署视频教程&自定义UI界面](https://s.xiaocichang.com/s/b9286c)
![1.png](4beeaded95251907995de4b878197a78.png)
参考博客[《\[YOLOv7\]基于YOLOv7的动物识别系统(源码＆部署教程)》](https://mbd.pub/o/qunma/work)
